    ...
    return (
      <Host>
        ...
        <ul>
          <li>
            <e-text>
              <strong>D17 (d). Typesense Search (OpenAI API)</strong>
              <br />
          ...
          <li>
            <e-text>
              <strong>D17 (c). Typesense Search (GCP Vertex API)</strong>
              <br />
          ...
          <li>
            <e-text>
              <strong>D17 (b). Typesense Search (Google PaLM API)</strong>
              <br />
          ...
          <li>
            <e-text>
              ...
              <br />
              Implements hybrid (keyword + semantic) search for <u>class & relation names</u> using embeddings generated the built-in ML model (S-BERT)
            </e-text>
            <l-spacer value={0.5}></l-spacer>
